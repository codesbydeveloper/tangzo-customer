const Map<String, String> lnAr = {
  ...
  "Log in to continue enjoying delicious food delivered to your doorstep.":
      "سجّل الدخول لمتابعة الاستمتاع بالطعام اللذيذ المقدم إلى بابك.",
  ...
  "Please enter minimum 6 characters password":
      "الرجاء إدخال كلمة مرور من 6 أحرف على الأقل",
  ...
  "Around the clock, our delivery partners bring you your favorite meals. Show your appreciation with a tip.":
      "يقدّم شركاؤنا بالتوصيل وجباتك المفضلة طوال الوقت. أظهر تقديرك لهم بإكرامية.",
  "Other": "أخرى",
  ...
  "Your delicious meal is on its way! Sit tight and we’ll handle the rest.":
      "وجبتك اللذيذة في الطريق إليك! اجلس واسترخِ وسنتولى الباقي.",
  "Order ID": "رقم الطلب",
  "Placing your order": "جاري تقديم طلبك",
  "Review your items and proceed to checkout for a delicious experience.":
      "راجع عناصر الطلب ثم تابع للدفع للحصول على تجربة لذيذة.",
  ...
  "Select your preferred language for a personalized app experience.":
      "اختر لغتك المفضلة لتجربة تطبيق مخصصة.",
  ...
  "Please log in to the application. You are not logged in.":
      "يرجى تسجيل الدخول. أنت غير مسجّل الدخول.",
  ...
  "Book a table at your favorite restaurant and enjoy a delightful dining experience.":
      "احجز طاولة في مطعمك المفضل واستمتع بتجربة طعام ممتعة.",
  ...
  "Currently, there are no available restaurants in your zone. Try changing your location to find nearby options.":
      "لا توجد مطاعم متاحة في منطقتك حالياً. حاول تغيير موقعك للعثور على خيارات قريبة.",
  ...
  "Do you really want to change the delivery option? Your cart will be empty.":
      "هل تريد حقًا تغيير خيار التوصيل؟ سيتم إفراغ السلة.",
  "Alert": "تنبيه",
  ...
  "Your Order has been Preparing and assign to the driver":
      "طلبك جارٍ تحضيره وتم تعيينه للسائق",
  "Your Order": "طلبك",
  ...
  "Keep track your delivered, In Progress and Rejected food all in just one place.":
      "تتبع طلباتك المُسلّمة، الجارية، والمرفوضة كلها في مكان واحد.",
  "All": "الكل",
  ...
  "Manage your personal information, preferences, and settings all in one place.":
      "إدارة معلوماتك الشخصية والتفضيلات والإعدادات في مكان واحد.",
  ...
  "Are you sure you want to log out? You will need to enter your credentials to log back in.":
      "هل أنت متأكد من تسجيل الخروج؟ ستحتاج إلى إدخال بياناتك لتسجيل الدخول مرة أخرى.",
  ...
  'This vendor has reached their maximum order capacity. Please select a different vendor or try again later.':
      'وصل هذا البائع إلى أقصى طاقته للطلبات. يرجى اختيار بائع آخر أو المحاولة لاحقًا.',
  ...
  "You don't have sufficient wallet balance to purchase gift card":
      "رصيد محفظتك غير كافٍ لشراء بطاقة هدايا",
  ...
  "This user is disable please contact to administrator":
      "هذا المستخدم غير مفعل، يرجى الاتصال بالإدارة",
  ...
  'This user is not created in customer application.':
      'لم يتم إنشاء هذا المستخدم في تطبيق العميل.',
  ...
  'Tap the mic to start voice recognition':
      'اضغط على الميكروفون لبدء التعرف على الصوت',
  'Speak now': 'تحدث الآن',
  ...
  "Sorry for the inconvenience but we're performing some maintenance at the moment. We'll be back online shortly!":
      "نعتذر عن الإزعاج، لكننا نقوم حاليًا ببعض أعمال الصيانة. سنعود للعمل قريبًا!",
  ...
  "Please select a future time for your Dine-In request.":
      "يرجى اختيار وقت مستقبلي لطلب تناول الطعام في المطعم.",
  'The restaurant is closed at the moment. Please try placing your order later.':
      'المطعم مغلق في الوقت الحالي. يرجى المحاولة مرة أخرى لاحقًا.',
  'This email address is not registered with an email and password.':
      'هذا البريد الإلكتروني غير مسجل باستخدام البريد الإلكتروني وكلمة المرور.',
  'The selected product is not available at your delivery address.':
      'المنتج الذي اخترته غير متوفر في عنوان التسليم الخاص بك.',
